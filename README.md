1. https://create.roblox.com/dashboard/credentials?activeTab=ApiKeysTab에 들어가 api키를 발급한다 해당 api키는 user-restrictions api시스템을 포함하여야한다(절대 유출해서는 안된다(git 등에 업로드 절대금지)) env파일에 저장한다
